...
class Uniswapv3 extends _i1.GeneratedContract {
  ...
  Future<_i1.EthereumAddress> WETH9({_i1.BlockNum? atBlock}) async {
  ...
  /// set by the contract.
  Future<String> exactInput(dynamic _params,
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> exactInputSingle(dynamic _params,
      {required _i1.Credentials credentials,
      _i1.Transaction? transaction}) async {
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> exactOutput(dynamic _params,
      {required _i1.Credentials credentials,
      _i1.Transaction? transaction}) async {
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> exactOutputSingle(dynamic _params,
      {required _i1.Credentials credentials,
      _i1.Transaction? transaction}) async {
