...
class Uniswapv3pool extends _i1.GeneratedContract {
  ...
  Future<String> collect(
    ...
    BigInt tickLower,
    BigInt tickUpper,
    BigInt amount0Requested,
    BigInt amount1Requested, {
    required _i1.Credentials credentials,
    _i1.Transaction? transaction,
  }) async {
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<BigInt> feeGrowthGlobal0X128({
    _i1.BlockNum? atBlock,
    _i1.EthereumAddress? sender,
  }) async {
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<BigInt> feeGrowthGlobal1X128({
    _i1.BlockNum? atBlock,
    _i1.EthereumAddress? sender,
  }) async {
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<BigInt> maxLiquidityPerTick({
    _i1.BlockNum? atBlock,
    _i1.EthereumAddress? sender,
  }) async {
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<Observations> observations(
    BigInt $param22, {
    _i1.BlockNum? atBlock,
    _i1.EthereumAddress? sender,
  }) async {
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<Observe> observe(
    List<BigInt> secondsAgos, {
    _i1.BlockNum? atBlock,
    _i1.EthereumAddress? sender,
  }) async {
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<ProtocolFees> protocolFees({
    _i1.BlockNum? atBlock,
    _i1.EthereumAddress? sender,
  }) async {
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<_i1.EthereumAddress> token0({
    _i1.BlockNum? atBlock,
    _i1.EthereumAddress? sender,
  }) async {
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<_i1.EthereumAddress> token1({
    _i1.BlockNum? atBlock,
    _i1.EthereumAddress? sender,
  }) async {
