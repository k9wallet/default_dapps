...
class Uniswap_v3_positions extends _i1.GeneratedContract {
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> collect(dynamic params,
      {required _i1.Credentials credentials,
      _i1.Transaction? transaction}) async {
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> createAndInitializePoolIfNecessary(_i1.EthereumAddress token0,
      _i1.EthereumAddress token1, BigInt fee, BigInt sqrtPriceX96,
      {required _i1.Credentials credentials,
      _i1.Transaction? transaction}) async {
    final function = self.abi.functions[9];
    assert(checkSignature(function, '13ead562'));
    final params = [token0, token1, fee, sqrtPriceX96];
    return write(credentials, transaction, function, params);
  }
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> decreaseLiquidity(dynamic params,
      {required _i1.Credentials credentials,
      _i1.Transaction? transaction}) async {
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> increaseLiquidity(dynamic params,
      {required _i1.Credentials credentials,
      _i1.Transaction? transaction}) async {
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> mint(dynamic params,
      {required _i1.Credentials credentials,
      _i1.Transaction? transaction}) async {
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> permit(_i1.EthereumAddress spender, BigInt tokenId,
      BigInt deadline, BigInt v, _i2.Uint8List r, _i2.Uint8List s,
      {required _i1.Credentials credentials,
      _i1.Transaction? transaction}) async {
    final function = self.abi.functions[19];
    assert(checkSignature(function, '7ac2ff7b'));
    final params = [spender, tokenId, deadline, v, r, s];
    return write(credentials, transaction, function, params);
  }
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<Positions> positions(BigInt tokenId, {_i1.BlockNum? atBlock}) async {
  ...
  Future<String> uniswapV3MintCallback(
      BigInt amount0Owed, BigInt amount1Owed, _i2.Uint8List data,
      {required _i1.Credentials credentials,
      _i1.Transaction? transaction}) async {
    final function = self.abi.functions[37];
    assert(checkSignature(function, 'd3487997'));
    final params = [amount0Owed, amount1Owed, data];
    return write(credentials, transaction, function, params);
  }
