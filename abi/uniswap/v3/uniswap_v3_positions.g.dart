...
class Uniswap_v3_positions extends _i1.GeneratedContract {
  Uniswap_v3_positions({
  ...
  Future<_i2.Uint8List> DOMAIN_SEPARATOR({
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<_i2.Uint8List> PERMIT_TYPEHASH({
    _i1.BlockNum? atBlock,
    _i1.EthereumAddress? sender,
  }) async {
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<_i1.EthereumAddress> WETH9({
    _i1.BlockNum? atBlock,
    _i1.EthereumAddress? sender,
  }) async {
    final function = self.abi.functions[3];
    assert(checkSignature(function, '4aa4a4fc'));
    final params = [];
    final response = await read(
      sender,
      function,
  ...
  Future<String> collect(
    ...
    assert(checkSignature(function, 'fc6f7865'));
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> createAndInitializePoolIfNecessary(
    _i1.EthereumAddress token0,
    _i1.EthereumAddress token1,
    BigInt fee,
    BigInt sqrtPriceX96, {
    required _i1.Credentials credentials,
    _i1.Transaction? transaction,
    ...
    assert(checkSignature(function, '13ead562'));
    final params = [
      token0,
      token1,
      fee,
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> decreaseLiquidity(
    dynamic params, {
    required _i1.Credentials credentials,
    _i1.Transaction? transaction,
  }) async {
    final function = self.abi.functions[10];
    assert(checkSignature(function, '0c49ccbe'));
    final _params = [params];
    return write(
      credentials,
      transaction,
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<_i1.EthereumAddress> factory({
    _i1.BlockNum? atBlock,
    _i1.EthereumAddress? sender,
  }) async {
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> increaseLiquidity(
    dynamic params, {
    required _i1.Credentials credentials,
    _i1.Transaction? transaction,
  }) async {
    final function = self.abi.functions[13];
    assert(checkSignature(function, '219f5d17'));
    final _params = [params];
    return write(
      credentials,
      transaction,
  ...
  Future<String> mint(
    ...
    assert(checkSignature(function, '88316456'));
    final _params = [params];
    return write(
      credentials,
      transaction,
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> multicall(
    List<_i2.Uint8List> data, {
    required _i1.Credentials credentials,
    _i1.Transaction? transaction,
  }) async {
    final function = self.abi.functions[16];
    assert(checkSignature(function, 'ac9650d8'));
    final params = [data];
    return write(
      credentials,
      transaction,
  ...
  Future<String> permit(
    ...
    assert(checkSignature(function, '7ac2ff7b'));
    final params = [
      spender,
      tokenId,
      deadline,
  ...
  Future<Positions> positions(
    ...
    assert(checkSignature(function, '99fbab88'));
    final params = [tokenId];
    final response = await read(
      sender,
      function,
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> refundETH({
    required _i1.Credentials credentials,
    _i1.Transaction? transaction,
  }) async {
    final function = self.abi.functions[21];
    assert(checkSignature(function, '12210e8a'));
    final params = [];
    return write(
      credentials,
      transaction,
  ...
  Future<String> selfPermit(
    ...
    assert(checkSignature(function, 'f3995c67'));
    final params = [
      token,
      value,
      deadline,
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> selfPermitAllowed(
    _i1.EthereumAddress token,
    BigInt nonce,
    BigInt expiry,
    BigInt v,
    ...
    assert(checkSignature(function, '4659a494'));
    final params = [
      token,
      nonce,
      expiry,
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> selfPermitAllowedIfNecessary(
    _i1.EthereumAddress token,
    BigInt nonce,
    BigInt expiry,
    BigInt v,
    ...
    assert(checkSignature(function, 'a4a78f0c'));
    final params = [
      token,
      nonce,
      expiry,
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> selfPermitIfNecessary(
    _i1.EthereumAddress token,
    BigInt value,
    BigInt deadline,
    BigInt v,
    ...
    assert(checkSignature(function, 'c2e3140a'));
    final params = [
      token,
      value,
      deadline,
  ...
  Future<String> sweepToken(
    ...
    assert(checkSignature(function, 'df2ab5bb'));
    final params = [
      token,
      amountMinimum,
      recipient,
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> uniswapV3MintCallback(
    BigInt amount0Owed,
    BigInt amount1Owed,
    _i2.Uint8List data, {
    required _i1.Credentials credentials,
    ...
    assert(checkSignature(function, 'd3487997'));
    final params = [
      amount0Owed,
      amount1Owed,
      data,
  ...
  Future<String> unwrapWETH9(
    ...
    assert(checkSignature(function, '49404b7c'));
    final params = [
      amountMinimum,
      recipient,
    ];
  ...
  /// Returns a live stream of all DecreaseLiquidity events emitted by this contract.
  Stream<DecreaseLiquidity> decreaseLiquidityEvents({
    _i1.BlockNum? fromBlock,
    _i1.BlockNum? toBlock,
  }) {
    final event = self.event('DecreaseLiquidity');
    final filter = _i1.FilterOptions.events(
      contract: self,
      event: event,
      fromBlock: fromBlock,
    ...
    return client.events(filter).map((_i1.FilterEvent result) {
      ...
      return DecreaseLiquidity(decoded);
    });
  }

  /// Returns a live stream of all IncreaseLiquidity events emitted by this contract.
  Stream<IncreaseLiquidity> increaseLiquidityEvents({
    _i1.BlockNum? fromBlock,
    _i1.BlockNum? toBlock,
  }) {
    final event = self.event('IncreaseLiquidity');
    final filter = _i1.FilterOptions.events(
      contract: self,
      event: event,
      fromBlock: fromBlock,
    ...
    return client.events(filter).map((_i1.FilterEvent result) {
      ...
      return IncreaseLiquidity(decoded);
    });
  }
...
class Positions {
  Positions(List<dynamic> response)
      : nonce = (response[0] as BigInt),
        ...
        token0 = (response[2] as _i1.EthereumAddress),
        token1 = (response[3] as _i1.EthereumAddress),
        fee = (response[4] as BigInt),
        tickLower = (response[5] as BigInt),
        tickUpper = (response[6] as BigInt),
        liquidity = (response[7] as BigInt),
        feeGrowthInside0LastX128 = (response[8] as BigInt),
        feeGrowthInside1LastX128 = (response[9] as BigInt),
        tokensOwed0 = (response[10] as BigInt),
        tokensOwed1 = (response[11] as BigInt);
...
class DecreaseLiquidity {
  DecreaseLiquidity(List<dynamic> response)
      : tokenId = (response[0] as BigInt),
        liquidity = (response[1] as BigInt),
        amount0 = (response[2] as BigInt),
        amount1 = (response[3] as BigInt);
...
class IncreaseLiquidity {
  IncreaseLiquidity(List<dynamic> response)
      : tokenId = (response[0] as BigInt),
        liquidity = (response[1] as BigInt),
        amount0 = (response[2] as BigInt),
        amount1 = (response[3] as BigInt);
